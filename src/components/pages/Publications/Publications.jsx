...
const Publications = () => {
  ...
  return (
    <div className="mt-5">
      <div className={` ${isDarkMode ? 'bg-gray-600' : 'bg-zinc-300'} rounded-md `}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5 p-5">
          {publication.map((item, index) => {
            return (
              <div key={index} className={`${getThemeClassNames(isDarkMode)} rounded-md px-14 py-10 text-justify shadow-lg flex flex-col justify-center items-center`}>
                <a href="https://example.com/">
                <p className="text-zinc-400">Publication</p>
